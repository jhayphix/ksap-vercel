before i the scholarship can be deteled , 

there when the user click on confirm, there should be a pop pup form for the user to type the name of scholarship ( scholarshipName) just as it appears, and if successfull that will be when the user can delete the scholarship, ( just as how it is in github, that before you can delete a github repo, you have to type the name to delete it)

implement same functionality for me 
